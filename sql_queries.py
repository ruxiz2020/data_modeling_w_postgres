...
user_id int references user_table, level varchar, song_id varchar NOT NULL references song_table,
artist_id varchar NOT NULL references artist_table, session_id int, location varchar, user_agent varchar);
""")
